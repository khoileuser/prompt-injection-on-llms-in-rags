...
class DocumentLoader:
    ...
    def __init__(self, documents_dir: Optional[str] = None):
        ...
        logger.info(
            f"Document loader initialized. Documents directory: {self.documents_dir}")
    ...
    def load_text_file(self, filename: str) -> Optional[str]:
        ...
        try:
            ...
            logger.info(
                f"Loaded text file: {filename} ({len(content)} characters)")
            return content
    ...
    def load_docx_file(self, filename: str) -> Optional[str]:
        ...
        try:
            ...
            logger.info(
                f"Loaded DOCX file: {filename} ({len(content)} characters)")
            return content
    ...
    def load_document(self, filename: str) -> Optional[str]:
        ...
        if file_ext == '.txt':
            ...
            logger.warning(
                f"Unknown file extension: {file_ext}, trying as text file")
            return self.load_text_file(filename)
    ...
    def create_sample_document(self, filename: str, content: str) -> bool:
        ...
        try:
            ...
            logger.error(
                f"Error creating sample document {filename}: {str(e)}")
            return False
